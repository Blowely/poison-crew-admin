...
export default async function handle(req,res) {
  ...
  const newBody = {
    "image_url": "https://storage.yandexcloud.net/pc-mediafiles-dev3/1710595878217.jpg",
  }

  const newAuthToken = '772de3cf3fc2a4594f5676e319a6d2b25605ae1f';
  ...
  const newReq = await axios(newOptions);
