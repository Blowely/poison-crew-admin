  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/links'} className={pathname.includes('/links') ? activeLink : inactiveLink}>
          <LinkOutlined />
          Links
        </Link>
        <Link href={'/addlink'} className={pathname.includes('/addlink') ? activeLink : inactiveLink}>
          <LinkOutlined />
          Add Link
        </Link>
